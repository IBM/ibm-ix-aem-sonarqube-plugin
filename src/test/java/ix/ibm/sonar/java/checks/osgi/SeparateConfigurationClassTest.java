...
class SeparateConfigurationClassTest {

    @Test
    @DisplayName("GIVEN a class, WHEN the class implementation has an object configuration, THEN the test should verify that this is not compliant")
    void detected() {
        CheckVerifier
          .newVerifier()
          .onFiles(TestConstants.OSGI_TEST_PATH + "SeparateConfigurationClassCheck.java")
          .withCheck(new SeparateConfigurationClassRule())
