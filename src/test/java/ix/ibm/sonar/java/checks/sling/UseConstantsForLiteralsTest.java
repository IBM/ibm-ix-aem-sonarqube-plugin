...
class UseConstantsForLiteralsTest {

    @Test
    @DisplayName("GIVEN a constant, WHEN not using provided available package constants, THEN the test should verify that this is not compliant")
    void detected() {
        CheckVerifier
          .newVerifier()
          .onFile(TestConstants.SLING_TEST_PATH + "UseConstantsForLiteralsCheck.java")
          .withCheck(new UseConstantsForLiteralsRule())
